...
contract Token {
    ...
    // imp*price = totalSupply + totalSupply*profitPerToken/multiplicator - sum(payoutsOf) + sum(refDividendsOf)
    // dividendsOf = balanceOf*profitPerToken/multiplicator - payoutsOf
    // allDividends = dividendsOf + refDividendsOf
    uint256 public constant price = 1; // tokens/imp
    ...
    /// @notice converts 90% of incoming pls in tokens, spreads rest as dividends
